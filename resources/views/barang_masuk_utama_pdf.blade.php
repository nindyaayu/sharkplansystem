...
<head>
    ...
    <title>
        Laporan Barang Masuk (Material Utama)
    </title>
...
<div class="judul-tabel">
    DATA BARANG MASUK MATERIAL UTAMA
</div>
...
<td class="text-right">
    {{ number_format($item->roll,0) }}
</td>

<td class="text-right">
    {{ number_format($item->meter,0) }}
</td>
...
<th class="text-right">
    {{ number_format($data->sum('roll'),0) }}
</th>

<th class="text-right">
    {{ number_format($data->sum('meter'),0) }}
</th>
